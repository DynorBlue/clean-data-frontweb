...
export const getCamionesByEstado = (estado) => api.get(`/camiones/estado/${estado}`);
...
window.resetCamionModal = () => {
    ...
    document.getElementById('camionEstado').value = 'DISPONIBLE';
};
...
window.editarCamion = async (id) => {
    try {
        ...
        document.getElementById('camionCapacidadKg').value = camion.capacidadKg || '';
        document.getElementById('camionCapacidadM3').value = camion.capacidadM3 || '';
        document.getElementById('camionEstado').value = camion.estado || 'DISPONIBLE';
